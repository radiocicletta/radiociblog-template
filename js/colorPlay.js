    ...
    for (var i = 0, offset, r, g, b, a; i < pixelCount; i++) {
        ...
        if (a >= 125) {
            if (!(r > 250 && g > 250 && b > 250)) {
                pixelArray.push([255-r-(r/4), 255-g-(g/4), 255-b-(b/4)]);
            }
        }
		if ((r > 100 || g > 100 || b > 100)) {
             $('#playercmd.play').css('background-position','-120px -1160px');
			$('#playercmd.stop').css('background-position','-360px -1160px');
			$('.secondrow').css('color','rgba(255, 255, 255, 1)');
			$('.firstrow').css('color','rgba(209, 197, 197, 1)');
			$('.thirdrow').css('color','rgba(209, 197, 197, 1)');
			$('.fourthrow').css('color','rgba(209, 197, 197, 1)');
         }
...
function convertImgToBase64(url, callback, outputFormat){
    ...
    var imageUrl = $('#logoprog').attr('src');
    console.log('imageUrl', imageUrl);
    convertImgToBase64(imageUrl, function(base64Img){
        $('#logoprog').attr('src', base64Img);
       
    });
	
$("#logoprog").load(function(){    
     ...
     var image = $('#logoprog');
        ...
        $('#showcasecontainer').css('background-color', 'rgba('+ dominantColor +', 0.7)');
